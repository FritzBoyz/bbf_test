class ascii_art_v2_1:

    def top_border(self, rows=2, width=41, pattern="#"):
        for i in range(rows):
            print(pattern * width)

    def bottom_border(self, rows=2, width=41, pattern="#"):
        for i in range(rows):
            print(pattern * width)

    def circle_pattern(self, *args):
        if len(args) == 4:
